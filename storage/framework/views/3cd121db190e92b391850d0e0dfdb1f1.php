...
<head>
    ...
    <title>Halaman Tidak Ditemukan - <?php echo e(config('app.name', 'Poros Aktual')); ?></title>
...
<body class="bg-gray-50 min-h-screen flex flex-col">
    ...
    <footer class="bg-white border-t py-4 text-center text-sm text-gray-400">
        &copy; <?php echo e(date('Y')); ?> <?php echo e(config('app.name', 'Poros Aktual')); ?>

    </footer>
</body>
</html>
<?php /**PATH E:\laragon\www\porosaktual\resources\views/errors/404.blade.php ENDPATH**/ ?>