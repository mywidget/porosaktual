...
Route::middleware(['auth', 'verified'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::post('/clear-views', [DashboardController::class, 'clearViews'])->name('dashboard.clear-views');
    ...
    Route::middleware('permission:manage-categories')->resource('categories', AdminCategoryController::class);
    ...
    Route::middleware('permission:manage-pages')->resource('pages', AdminPageController::class);
    ...
    Route::middleware('permission:manage-media')->resource('media', MediaController::class)->only(['index', 'store', 'destroy']);
