...
<body class="dark:bg-gray-900 dark:text-gray-100 bg-white text-gray-900 min-h-screen flex flex-col">
    ...
    <div x-data="{ paused: false }" class="bg-red-600 text-white overflow-hidden">
        <div class="max-w-7xl mx-auto flex items-center">
            <div class="flex-shrink-0 px-4 py-2 bg-red-700 font-bold text-xs uppercase tracking-wider flex items-center space-x-1">
            ...
            <div class="overflow-hidden flex-1 relative h-10 flex items-center"
                ...
                <template x-for="(item, index) in items" :key="index">
                    <a :href="item.url || '#'"
                       ...
                       class="absolute inset-0 flex items-center px-4 text-sm font-medium whitespace-nowrap overflow-hidden text-ellipsis hover:underline">
