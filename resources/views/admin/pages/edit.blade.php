            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border border-gray-100 dark:border-gray-700">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="content" id="content" rows="15" class="w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 font-mono text-sm" placeholder="Tulis konten halaman di sini...">{{ old('content', $page->content) }}</textarea>
                    </div>
