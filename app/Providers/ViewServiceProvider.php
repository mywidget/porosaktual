...
class ViewServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        View::composer('*', function ($view) {
            ...
            $view->with('breakingNewsItems', \App\Models\BreakingNews::with('post')->where('is_active', true)->where('start_date', '<=', now())->where(function ($q) {
        ...
        View::composer(['layouts.frontend', 'components.*'], function ($view) {
